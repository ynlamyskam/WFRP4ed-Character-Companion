        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasSpecialization = table.Column<bool>(type: "INTEGER", nullable: false),
                    GoverningAttribute = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxLevelType = table.Column<int>(type: "INTEGER", nullable: false),
                    FixedMaxLevel = table.Column<int>(type: "INTEGER", nullable: true),
                    MaxLevelAttributes = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "TalentTestEffects",
                columns: table => new
                {
                    TalentId = table.Column<int>(type: "INTEGER", nullable: false),
                    SkillName = table.Column<string>(type: "TEXT", nullable: false),
                    Condition = table.Column<string>(type: "TEXT", nullable: true),
                    BonusPerLevelAbove1 = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TalentTestEffects", x => new { x.TalentId, x.SkillName });
                    table.ForeignKey(
                        name: "FK_TalentTestEffects_Talents_TalentId",
                        column: x => x.TalentId,
